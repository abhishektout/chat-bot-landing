...
const faqs = [
  ...
  { q: "Can I connect my database or CRM?", a: "Yes! SupportAI integrates with PostgreSQL, MySQL, REST APIs, HubSpot, Salesforce, Shopify, and custom CRMs. The AI can query real-time data to answer customer questions about orders, accounts, or any live information." },
...
export default function FAQSection() {
  return (
    <section id="faq" style={{ position: "relative", overflow: "hidden", padding: "96px 0" }}>
      ...
      <div style={{ position: "relative", zIndex: 10, maxWidth: "860px", margin: "0 auto", padding: "0 24px" }}>
        <motion.div initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} style={{ textAlign: "center", marginBottom: "52px" }}>
          <span className="badge" style={{ marginBottom: "16px" }}>❓ FAQ</span>
          ...
          <p style={{ fontSize: "18px", color: "var(--muted-fg)" }}>Everything you need to know about SupportAI.</p>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="card-gradient-border" style={{ marginTop: "40px", padding: "36px", textAlign: "center" }}>
          ...
          <p style={{ fontSize: "14px", color: "var(--muted-fg)", marginBottom: "20px" }}>Our team is ready to help you evaluate if SupportAI is the right fit.</p>
